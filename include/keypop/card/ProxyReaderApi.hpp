...
/**
 * Reader able to transmit card requests and having control over the physical
 * channel.
 *
...
public:
    ...
    /**
     * Transmits a keypop::card::CardRequestSpi, applies the provided
     * keypop::card::ChannelControl policy and returns a
     ...
     * keypop::card::CardRequestSpi or to have strict control over the APDUs
     * sent to the card (see
     * keypop::card::CardRequestSpi::stopOnUnsuccessfulStatusWord()).
     *
     * @param cardRequest The card request.
     * @param channelControl The channel control policy to apply.
     * @return A not null reference.
     * @throw IllegalArgumentException If one of the provided parameters is
     * null.
     ...
     * card has failed.
     * @throw UnexpectedStatusWordException If any of the APDUs returned an
     * unexpected status word and the card request specified the need to check
     * them.
     * @since 1.0.0
     */
